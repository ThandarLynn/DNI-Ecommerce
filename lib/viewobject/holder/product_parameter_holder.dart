...
class ProductParameterHolder extends AppHolder<dynamic> {
  ProductParameterHolder() {
    ...
    orderType = AppConst.FILTERING__DESC;
  }
  ...
  ProductParameterHolder getFeaturedParameterHolder() {
    ...
    ratingValueFour = '';
    ratingValueFive = '';
    orderBy = AppConst.FILTERING_FEATURE;
    orderType = AppConst.FILTERING__DESC;
  ...
  ProductParameterHolder getTrendingParameterHolder() {
    ...
    ratingValueFour = '';
    ratingValueFive = '';
    orderBy = AppConst.FILTERING_TRENDING;
    orderType = AppConst.FILTERING__DESC;
