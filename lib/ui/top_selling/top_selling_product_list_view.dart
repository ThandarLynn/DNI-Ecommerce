...
class TopSellingProductListView extends StatefulWidget {
  const TopSellingProductListView({Key key, @required this.animationController})
      : super(key: key);
  final AnimationController animationController;
  @override
  _TopSellingProductListView createState() => _TopSellingProductListView();
}

class _TopSellingProductListView extends State<TopSellingProductListView>
    with TickerProviderStateMixin {
  final ScrollController _scrollController = ScrollController();

  TopSellingProductProvider _favouriteProductProvider;
  ...
  void initState() {
    _scrollController.addListener(() {
      if (_scrollController.position.pixels ==
        ...
        _favouriteProductProvider.nextTopSellingProductList();
      }
    });
  ...
  Widget build(BuildContext context) {
    ...
    print(
        '............................Build UI Again ............................');
    return ChangeNotifierProvider<TopSellingProductProvider>(
      lazy: false,
      ...
      child: Consumer<TopSellingProductProvider>(
        builder: (BuildContext context, TopSellingProductProvider provider,
            Widget child) {
          return Column(
            children: <Widget>[
                ...
                child: Stack(children: <Widget>[
                  Container(
                      ...
                      child: RefreshIndicator(
                        ...
                        onRefresh: () {
                          return provider.resetTopSellingProductList();
                        },
                      )),
