...
import 'package:dni_ecommerce/ui/common/ps_widget_with_no_app_bar_title.dart';
...
class GalleryView extends StatefulWidget {
  ...
  final Gallery selectedDefaultImage;
...
class _GalleryViewState extends State<GalleryView> {
  ...
  Widget build(BuildContext context) {
    ...
    print(
        '............................Build UI Again ............................');
    return AppWidgetWithNoAppBarTitle<GalleryProvider>(
      initProvider: () {
                ...
                builder: (BuildContext context, int index) {
                  return PhotoViewGalleryPageOptions.customChild(
                    child: AppNetworkImageWithUrl(
                      ...
                      imagePath: provider.galleryList.data[index].url,
